        ...
        <div className="report-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', padding: '8px 0' }}>
            {[
              ...
              <div key={item.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 12px', background: 'rgba(15,23,42,0.03)', borderRadius: '8px', border: '1px solid var(--border)' }}>
